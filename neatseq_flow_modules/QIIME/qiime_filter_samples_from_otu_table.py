...
class Step_qiime_filter_samples_from_otu_table(Step):
    ...
    def step_specific_init(self):
        ...
        self.file_tag = "qiime_filter_samples_from_otu_table"
    ...
    def build_scripts(self):
        ...
        self.script += "--output_mapping_fp %s \n\n" % "".join([use_dir,"mapping_filtered.txt"])
        
            
        self.sample_data["project_data"]["biom_table"] = "".join([self.base_dir,filtered_biom_table])
        self.sample_data["project_data"]["qiime.mapping"] = "".join([self.base_dir,"mapping_filtered.txt"])
