...
option_list = list(
  ...
  make_option(c("--Minimal_PATHWAY_SIZE"), type="numeric", default = 20, 
              help="The Minimal Number of Genes Observed in a Sample that Belong to Spesific Pathway, Pathways With Less Will be Discarded , The Default is 20", metavar="character"),
  ...
  make_option(c("--PATHWAY_Reference"), type="character", default=NA, 
              help="A KEGG Pathay to use as a reference for sub-setig all other avialble pathways ", metavar="character"),
